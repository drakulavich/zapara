...
| `streak` | Minutes of the presence streak the hour ended in. Presence is every action you take: a prompt, an interrupt, a tool rejection. A streak is a run of them no more than 10 minutes apart, across sessions, and it may reach back before the hour. Agent activity between two of your actions does not bridge a gap. |
